...
st.markdown("<h2 style='text-align: left; color: black;'>Data Science Enthusiast </h2>", unsafe_allow_html=True)



st.markdown("I am Kavya . Data science enthusiast Looking for New Challenges/Opportunities in the field of Data  Science and an aspiring Data scientist who enjoys connecting the dots: be it ideas from different disciplines, people from different teams, or applications from different industries.I have strong technical skills and an academic background in engineering, statistics, and machine learning.")
